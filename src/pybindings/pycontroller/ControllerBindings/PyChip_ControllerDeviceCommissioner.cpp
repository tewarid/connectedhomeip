...
struct PyCallBack_chip_app_InteractionModelDelegate : public chip::app::InteractionModelDelegate {
	...
	int EventStreamReceived(const class chip::Messaging::ExchangeContext * a0, class chip::TLV::TLVReader * a1) override {
		...
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "EventStreamReceived");
		if (overload) {
	...
	int ReportProcessed(const class chip::app::ReadClient * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "ReportProcessed");
		if (overload) {
	...
	int ReportError(const class chip::app::ReadClient * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "ReportError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseStatus(const class chip::app::CommandSender * a0, const enum chip::Protocols::SecureChannel::GeneralStatusCode a1, const unsigned int a2, const unsigned short a3, unsigned char a4, const unsigned short a5, unsigned char a6, unsigned char a7) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "CommandResponseStatus");
		if (overload) {
	...
	int CommandResponseProcessed(const class chip::app::CommandSender * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "CommandResponseProcessed");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseProtocolError(const class chip::app::CommandSender * a0, unsigned char a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "CommandResponseProtocolError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseError(const class chip::app::CommandSender * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "CommandResponseError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseStatus(const class chip::app::WriteClient * a0, const enum chip::Protocols::SecureChannel::GeneralStatusCode a1, const unsigned int a2, const unsigned short a3, struct chip::app::AttributePathParams & a4, unsigned char a5) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "WriteResponseStatus");
		if (overload) {
	...
	int WriteResponseProcessed(const class chip::app::WriteClient * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "WriteResponseProcessed");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseProtocolError(const class chip::app::WriteClient * a0, unsigned char a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "WriteResponseProtocolError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseError(const class chip::app::WriteClient * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::app::InteractionModelDelegate *>(this), "WriteResponseError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
...
struct PyCallBack_chip_Controller_DeviceControllerInteractionModelDelegate : public chip::Controller::DeviceControllerInteractionModelDelegate {
	...
	int CommandResponseStatus(const class chip::app::CommandSender * a0, const enum chip::Protocols::SecureChannel::GeneralStatusCode a1, const unsigned int a2, const unsigned short a3, unsigned char a4, const unsigned short a5, unsigned char a6, unsigned char a7) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "CommandResponseStatus");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1, a2, a3, a4, a5, a6, a7);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseProtocolError(const class chip::app::CommandSender * a0, unsigned char a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "CommandResponseProtocolError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseError(const class chip::app::CommandSender * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "CommandResponseError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int CommandResponseProcessed(const class chip::app::CommandSender * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "CommandResponseProcessed");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int EventStreamReceived(const class chip::Messaging::ExchangeContext * a0, class chip::TLV::TLVReader * a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "EventStreamReceived");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int ReportProcessed(const class chip::app::ReadClient * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "ReportProcessed");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int ReportError(const class chip::app::ReadClient * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "ReportError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseStatus(const class chip::app::WriteClient * a0, const enum chip::Protocols::SecureChannel::GeneralStatusCode a1, const unsigned int a2, const unsigned short a3, struct chip::app::AttributePathParams & a4, unsigned char a5) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "WriteResponseStatus");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1, a2, a3, a4, a5);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseProcessed(const class chip::app::WriteClient * a0) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "WriteResponseProcessed");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseProtocolError(const class chip::app::WriteClient * a0, unsigned char a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "WriteResponseProtocolError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
	...
	int WriteResponseError(const class chip::app::WriteClient * a0, int a1) override {
		pybind11::gil_scoped_acquire gil;
		pybind11::function overload = pybind11::get_overload(static_cast<const chip::Controller::DeviceControllerInteractionModelDelegate *>(this), "WriteResponseError");
		if (overload) {
			auto o = overload.operator()<pybind11::return_value_policy::reference>(a0, a1);
			if (pybind11::detail::cast_is_temporary_value_reference<int>::value) {
				static pybind11::detail::override_caster_t<int> caster;
...
;
	...
	{ // chip::app::InteractionModelDelegate file:app/InteractionModelDelegate.h line:44
		pybind11::class_<chip::app::InteractionModelDelegate, std::shared_ptr<chip::app::InteractionModelDelegate>, PyCallBack_chip_app_InteractionModelDelegate> cl(M("chip::app"), "InteractionModelDelegate", "This class defines the API for a delegate that an SDK consumer can use to interface with the interaction model.");
		cl.def( pybind11::init( [](){ return new chip::app::InteractionModelDelegate(); }, [](){ return new PyCallBack_chip_app_InteractionModelDelegate(); } ) );
		cl.def( pybind11::init( [](PyCallBack_chip_app_InteractionModelDelegate const &o){ return new PyCallBack_chip_app_InteractionModelDelegate(o); } ) );
		cl.def( pybind11::init( [](chip::app::InteractionModelDelegate const &o){ return new chip::app::InteractionModelDelegate(o); } ) );
		cl.def("EventStreamReceived", (int (chip::app::InteractionModelDelegate::*)(const class chip::Messaging::ExchangeContext *, class chip::TLV::TLVReader *)) &chip::app::InteractionModelDelegate::EventStreamReceived, "Notification that the interaction model has received a list of events in response to a Read request and that list\n of events needs to be processed.\n \n\n   An exchange context that represents the exchange the Report Data came in on.\n                                 This can be used to recover the NodeId of the node that sent the Report Data.\n                                 It is managed externally and should not be closed by the SDK consumer.\n \n\n  TLV reader positioned at the list that contains the events.  The\n                                implementation of EventStreamReceived is expected to call Next() on the reader to\n                                advance it to the first element of the list, then process the elements from beginning to the\n                                end. The callee is expected to consume all events.\n\n   # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::EventStreamReceived(const class chip::Messaging::ExchangeContext *, class chip::TLV::TLVReader *) --> int", pybind11::arg("apExchangeContext"), pybind11::arg("apEventListReader"));
		cl.def("ReportProcessed", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::ReadClient *)) &chip::app::InteractionModelDelegate::ReportProcessed, "Notification that the last message for a Report Data action for the given ReadClient has been received and processed.\n \n\n   A current readClient which can identify the read to the consumer, particularly during\n                            multiple read interactions\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::ReportProcessed(const class chip::app::ReadClient *) --> int", pybind11::arg("apReadClient"));
		cl.def("ReportError", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::ReadClient *, int)) &chip::app::InteractionModelDelegate::ReportError, "Notification that a read attempt encountered an asynchronous failure.\n \n\n   A current readClient which can identify the read to the consumer, particularly during\n                            multiple read interactions\n \n\n         A error that could be CHIP_ERROR_TIMEOUT when read client fails to receive, or other error when\n                            fail to process report data.\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::ReportError(const class chip::app::ReadClient *, int) --> int", pybind11::arg("apReadClient"), pybind11::arg("aError"));
		cl.def("CommandResponseStatus", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::CommandSender *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, unsigned char, const unsigned short, unsigned char, unsigned char)) &chip::app::InteractionModelDelegate::CommandResponseStatus, "Notification that a Command Send has received an Invoke Command Response containing a status code.\n \n\n A current command sender which can identify the command sender to the consumer, particularly\n during multiple command interactions\n \n\n   Status code defined by the standard\n \n\n    Protocol Id\n \n\n  Detailed error information, protocol-specific.\n \n\n    Endpoint identifier\n \n\n     Cluster identifier\n \n\n     Command identifier\n \n\n  Current processing command index which can identify command if there exists multiple commands with\n same command Id\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::CommandResponseStatus(const class chip::app::CommandSender *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, unsigned char, const unsigned short, unsigned char, unsigned char) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aGeneralCode"), pybind11::arg("aProtocolId"), pybind11::arg("aProtocolCode"), pybind11::arg("aEndpointId"), pybind11::arg("aClusterId"), pybind11::arg("aCommandId"), pybind11::arg("aCommandIndex"));
		cl.def("CommandResponseProcessed", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::CommandSender *)) &chip::app::InteractionModelDelegate::CommandResponseProcessed, "Notification that a Command Response has already been processed.\n \n\n A current command sender which can identify the command sender to the consumer, particularly\n during multiple command interactions\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::CommandResponseProcessed(const class chip::app::CommandSender *) --> int", pybind11::arg("apCommandSender"));
		cl.def("CommandResponseProtocolError", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::CommandSender *, unsigned char)) &chip::app::InteractionModelDelegate::CommandResponseProtocolError, "Notification that a Command Send has received an Invoke Command Response and fails to process a command data element in that\n command response\n \n\n A current command sender which can identify the command sender to the consumer, particularly\n during multiple command interactions\n \n\n  Current processing command index which can identify failed command\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::CommandResponseProtocolError(const class chip::app::CommandSender *, unsigned char) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aCommandIndex"));
		cl.def("CommandResponseError", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::CommandSender *, int)) &chip::app::InteractionModelDelegate::CommandResponseError, "Notification that a command sender encountered an asynchronous failure.\n \n\n A current command sender which can identify the command sender to the consumer, particularly\n during multiple command interactions\n \n\n         A error that could be CHIP_ERROR_TIMEOUT when command sender fails to receive, or other error when\n                            fail to process command response.\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::CommandResponseError(const class chip::app::CommandSender *, int) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aError"));
		cl.def("WriteResponseStatus", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::WriteClient *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, struct chip::app::AttributePathParams &, unsigned char)) &chip::app::InteractionModelDelegate::WriteResponseStatus, "Notification that a WriteClient has received an Write Response containing a status code.\n\nC++: chip::app::InteractionModelDelegate::WriteResponseStatus(const class chip::app::WriteClient *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, struct chip::app::AttributePathParams &, unsigned char) --> int", pybind11::arg("apWriteClient"), pybind11::arg("aGeneralCode"), pybind11::arg("aProtocolId"), pybind11::arg("aProtocolCode"), pybind11::arg("aAttributePathParams"), pybind11::arg("aCommandIndex"));
		cl.def("WriteResponseProcessed", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::WriteClient *)) &chip::app::InteractionModelDelegate::WriteResponseProcessed, "Notification that a Write Response has already been processed.\n\nC++: chip::app::InteractionModelDelegate::WriteResponseProcessed(const class chip::app::WriteClient *) --> int", pybind11::arg("apWriteClient"));
		cl.def("WriteResponseProtocolError", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::WriteClient *, unsigned char)) &chip::app::InteractionModelDelegate::WriteResponseProtocolError, "Notification that a Write Client has received an Write Response and fails to process a attribute data element in that\n write response\n\nC++: chip::app::InteractionModelDelegate::WriteResponseProtocolError(const class chip::app::WriteClient *, unsigned char) --> int", pybind11::arg("apWriteClient"), pybind11::arg("aAttributeIndex"));
		cl.def("WriteResponseError", (int (chip::app::InteractionModelDelegate::*)(const class chip::app::WriteClient *, int)) &chip::app::InteractionModelDelegate::WriteResponseError, "Notification that a write client encountered an asynchronous failure.\n \n\n write interactions\n \n\n         A error that could be CHIP_ERROR_TIMEOUT when write client fails to receive, or other error when\n                            fail to process write response.\n  # CHIP_ERROR_NOT_IMPLEMENTED if not implemented\n\nC++: chip::app::InteractionModelDelegate::WriteResponseError(const class chip::app::WriteClient *, int) --> int", pybind11::arg("apWriteClient"), pybind11::arg("aError"));
		cl.def("assign", (class chip::app::InteractionModelDelegate & (chip::app::InteractionModelDelegate::*)(const class chip::app::InteractionModelDelegate &)) &chip::app::InteractionModelDelegate::operator=, "C++: chip::app::InteractionModelDelegate::operator=(const class chip::app::InteractionModelDelegate &) --> class chip::app::InteractionModelDelegate &", pybind11::return_value_policy::automatic, pybind11::arg(""));
	}
	{ // chip::Controller::DeviceControllerInteractionModelDelegate file:controller/CHIPDeviceController.h line:158
		pybind11::class_<chip::Controller::DeviceControllerInteractionModelDelegate, std::shared_ptr<chip::Controller::DeviceControllerInteractionModelDelegate>, PyCallBack_chip_Controller_DeviceControllerInteractionModelDelegate, chip::app::InteractionModelDelegate> cl(M("chip::Controller"), "DeviceControllerInteractionModelDelegate", "Used for make current OnSuccessCallback & OnFailureCallback works when interaction model landed, it will be removed\n after #6308 is landed.");
		...
		cl.def("CommandResponseStatus", (int (chip::Controller::DeviceControllerInteractionModelDelegate::*)(const class chip::app::CommandSender *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, unsigned char, const unsigned short, unsigned char, unsigned char)) &chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseStatus, "C++: chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseStatus(const class chip::app::CommandSender *, const enum chip::Protocols::SecureChannel::GeneralStatusCode, const unsigned int, const unsigned short, unsigned char, const unsigned short, unsigned char, unsigned char) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aGeneralCode"), pybind11::arg("aProtocolId"), pybind11::arg("aProtocolCode"), pybind11::arg("aEndpointId"), pybind11::arg("aClusterId"), pybind11::arg("aCommandId"), pybind11::arg("aCommandIndex"));
		cl.def("CommandResponseProtocolError", (int (chip::Controller::DeviceControllerInteractionModelDelegate::*)(const class chip::app::CommandSender *, unsigned char)) &chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseProtocolError, "C++: chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseProtocolError(const class chip::app::CommandSender *, unsigned char) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aCommandIndex"));
		cl.def("CommandResponseError", (int (chip::Controller::DeviceControllerInteractionModelDelegate::*)(const class chip::app::CommandSender *, int)) &chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseError, "C++: chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseError(const class chip::app::CommandSender *, int) --> int", pybind11::arg("apCommandSender"), pybind11::arg("aError"));
		cl.def("CommandResponseProcessed", (int (chip::Controller::DeviceControllerInteractionModelDelegate::*)(const class chip::app::CommandSender *)) &chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseProcessed, "C++: chip::Controller::DeviceControllerInteractionModelDelegate::CommandResponseProcessed(const class chip::app::CommandSender *) --> int", pybind11::arg("apCommandSender"));
