...
# def PlatformMainLoop():
#     print("Platform main loop started.")
...
if is_linux_platform:
    DeviceLayer.Internal.BLEMgrImpl().ConfigureBle(0, False)
...
# InteractionModelDelegate
class PyDeviceControllerInteractionModelDelegate(Controller.DeviceControllerInteractionModelDelegate):
    def CommandResponseStatus(self, apCommandSender, aGeneralCode, aProtocolId, aProtocolCode, aEndpointId, aClusterId, aCommandId, aCommandIndex):
        return 0
    
    def CommandResponseProtocolError(self, apCommandSender, aCommandIndex):
        return 0

    def CommandResponseError(self, CommandSender, aError):
        return 0
    
    def CommandResponseProcessed(self, CommandSender):
        return 0
